...
const TopBar: React.FC<TopBarProps> = ({ onMenuToggle, pageTitle }) => {
  ...
  const handleSearch = async (query: string) => {
    ...
    try {
      ...
      const mockResults = [
        { type: 'customer', name: 'Ahmed Khan', email: 'ahmed.khan@email.com', id: 'CUST001' },
        { type: 'transaction', ref: 'TXN123456', amount: '£500', customer: 'Ahmed Khan' },
        { type: 'beneficiary', name: 'Mohammad Khan', iban: 'PK36SCBL0000001123456702' },
      ].filter(item => 
